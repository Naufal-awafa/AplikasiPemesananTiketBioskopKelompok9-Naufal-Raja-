...
<div class="grid-2 mb-24">
    ...
    <a href="walkin.php" class="card glass reveal" style="text-align:center; padding:34px;">
        ...
        <p class="mt-16" style="font-weight:800; font-size:1.05rem;">Pesan Tiket Walk-in</p>
        <p class="text-muted mt-8" style="font-size:.85rem;">Layani pembelian tiket langsung di loket dengan pembayaran tunai.</p>
    </a>
</div>

<div class="card glass reveal">
    <h3 style="font-size:1rem; font-weight:800; margin-bottom:16px;"><?= ikon('receipt', 18) ?> Transaksi Hari Ini</h3>
    <?php if (empty($tiketHariIni)): ?>
